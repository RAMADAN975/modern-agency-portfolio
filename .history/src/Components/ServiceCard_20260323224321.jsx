...
const ServiceCard = ({ service, index }) => {
    return (
        <div className='relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-gray-100 dark:shadow-white/10'>
            ...
            <div className='pointer-event-none blur-2xl rounded-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 w-[300px] h-[360px] absolute z-0 transition-opacity duration-500 mix-blend-lighten'>
